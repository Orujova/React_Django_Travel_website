          ...
          <div className="container_main">
            <div className="whereFlying">
              <div className="whereFlying_tab">
                ...
                >
                  <FaPlane style={{ fontSize: "24px", marginRight: "10px" }} />{" "}
                  Flights
                </div>
                <div
                ...
                >
                  <IoIosBed style={{ fontSize: "24px", marginRight: "10px" }} />
                  Stays
                </div>
              </div>
              <div
              ...
              >
                <form action="">
                  <fieldset>
                    ...
                    />
                    <IoIosBed style={{ fontSize: "24px", marginRight: "16px" }} />
                  </fieldset>
                  <fieldset>
            ...
            <div className="flight_hotel">
              <div
                className="flights"
                style={{ backgroundImage: `url(${flightimgPath})` }}
              >
              ...
              <div
                className="hotels"
                style={{ backgroundImage: `url(${hotelimgPath})` }}
              >
