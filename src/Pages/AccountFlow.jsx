      ...
      <div className="container_main">
        ...
        <div className="accountflow__page">
          <div className="account_1">
            <div
              style={showFlight ? { display: "block" } : { display: "none" }}
            >
              {data.length
                ? data.map((ticket) => {
                    return (
            ...
            >
              <div>
                <h2>Price</h2>
                <span>
                  {discount && showFlight ? ticketPrice + 50 : ticketPrice}$
                </span>
              </div>
          ...
          <div className="account_1">
            ...
            <div
              style={showStays ? { display: "block" } : { display: "none" }}
              className="basket__card"
            >
              <div>
                <h2>Price</h2>
                <span>
                  {discount && showStays ? hotelPrice + 50 : hotelPrice}$
                </span>
              </div>
          ...
          {showModal && (
            <div className="modal">
              <form onSubmit={handleSubmit}>
                ...
                />
                <fieldset
                  style={errors.cardnumber ? { borderColor: "red" } : null}
                >
                ...
                <div>
                  <div className="expdate">
                    <fieldset
                      style={errors.expdate ? { borderColor: "red" } : null}
                    >
                  ...
                  <div className="expdate">
                    <fieldset
                      style={errors.cvc ? { borderColor: "red" } : null}
                    >
                      <legend>CVC</legend>
                      <input
                        name="cvc"
                ...
                <fieldset
                  style={errors.nameoncard ? { borderColor: "red" } : null}
                >
                ...
                <fieldset
                  style={errors.country ? { borderColor: "red" } : null}
                >
