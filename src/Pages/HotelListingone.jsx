...
const Rectangle_16 = "Rectangle 16.png";
const Rectangle_16Path = `/static/${Rectangle_16}`;
const Line_1 = "Line 1.png";
const Line_1Path = `/static/${Line_1}`;
        ...
        <div className="container">
          <section className="hotel_listing_roadmap">
            <div className="hotel_listing_roadmap_box">
              <div>
                <IoIosBed style={{width:"20px",marginRight:"12px"}}/>
            ...
            <div className="hotel_listing_roadmap_box">
              <div>
                <div>
                  <BsPersonFill style={{width:"20px",marginRight:"12px"}}/>
